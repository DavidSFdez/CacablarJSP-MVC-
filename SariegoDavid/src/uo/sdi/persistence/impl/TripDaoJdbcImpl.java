...
public class TripDaoJdbcImpl implements TripDao {
    ...
    @Override
    public List<Trip> findPromotedTrips(Long id) {
	return jdbcTemplate.queryForList("TRIP_FIND_PROMOTED_TRIPS",
		new TripMapper(), id);
    }

    @Override
    public Long findNewTripId() {
	return jdbcTemplate.queryForObject("TRIP_FIND_MAX_ID_TRIP",
		new TripMapper()).getId() + 1;
    ...
    @Override
    public List<Trip> findAllActiveToUser(Long id) {
	return jdbcTemplate.queryForList("TRIP_FIND_ALL_ACTIVE_TO_USER",
		new TripMapper(),id, id, id);
    }

    @Override
    public List<Trip> findRelatedTrips(Long id) {
	return jdbcTemplate.queryForList("TRIP_FIND_ALL_RELATED",
		new TripMapper(), id, id, id);
    }

    @Override
    public List<Trip> findAllActiveOrderByDepartureCity() {

	return jdbcTemplate.queryForList(
		"TRIP_ORDER_DEPARTURE_CITY_FIND_ALL_ACTIVE", new TripMapper());
    }

    @Override
    public List<Trip> findAllActiveOrderByDestinationCity() {

	return jdbcTemplate
		.queryForList("TRIP_ORDER_DESTINATION_CITY_FIND_ALL_ACTIVE",
			new TripMapper());
    }

    @Override
    public List<Trip> findAllActiveToUserOrderByDepartureCity(Long id) {
	return jdbcTemplate.queryForList(
    ...
    @Override
    public List<Trip> findAllActiveToUserOrderByDestinationCity(Long id) {
	return jdbcTemplate.queryForList(
		"TRIP_ORDER_DESTINATION_CITY_FIND_ALL_ACTIVE_TO_USER_ORDER",
		new TripMapper(),id, id, id);
    }

    @Override
    public List<Trip> findAllActiveFiltrado(String filtrado) {
	return jdbcTemplate.queryForList("TRIP_FILTRADO_FIND_ALL_ACTIVE",
		new TripMapper(), filtrado);
    }

    @Override
    public List<Trip> findAllActiveToUserFiltrado(Long id, String filtrado) {
	return jdbcTemplate.queryForList(
		"TRIP_FILTRADO_FIND_ALL_ACTIVE_TO_USER_ORDER",
		new TripMapper(), id, id, filtrado);
    }

    @Override
    public List<Trip> findRelatedTripsOrderByDepartureCity(Long id) {
	return jdbcTemplate.queryForList(
		"TRIP_ORDER_DEPARTURE_CITY_FIND_ALL_RELATED", new TripMapper(),
		id, id, id);
    }

    @Override
    public List<Trip> findRelatedTripsOrderByDestinationCity(Long id) {
	return jdbcTemplate.queryForList(
		"TRIP_ORDER_DESTINATION_CITY_FIND_ALL_RELATED",
		new TripMapper(), id, id, id);
    }

    @Override
    public List<Trip> findRelatedTripsFiltrado(Long id, String filtrado) {
	return jdbcTemplate.queryForList("TRIP_FILTRADO_FIND_ALL_RELATED",
		new TripMapper(), id, id, id, filtrado);
    }

    @Override
    public List<Trip> findActiveTripsToUpdateStatus() {
	return jdbcTemplate.queryForList("TRIPS_ACTIVE_TO_UPDATE",
		new TripMapper());
    }
